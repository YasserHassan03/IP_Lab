...
module accel_mm_interconnect_0_router_default_decode
  #(
...
module accel_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD12 = log2ceil(64'h810aa - 64'h810a8); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h810aa;
    ...
    accel_mm_interconnect_0_router_default_decode the_default_decode(
    ...
    // ( 0x81098 .. 0x810a0 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 20'h81098  && read_transaction  ) begin
    ...
    // ( 0x810a8 .. 0x810aa )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 20'h810a8   ) begin
