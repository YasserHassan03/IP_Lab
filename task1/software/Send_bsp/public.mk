...
SOPCINFO_FILE := C:/Users/james/Desktop/Imperial/Informationprocessing/Lab3/task1/accel.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x81098
SOPC_SYSID_FLAG += --sidp=0x81098
ELF_PATCH_FLAG  += --sidp 0x81098

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1678805931
SOPC_SYSID_FLAG += --timestamp=1678805931
ELF_PATCH_FLAG  += --timestamp 1678805931
