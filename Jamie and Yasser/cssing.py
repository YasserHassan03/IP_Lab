...
def GraphRobert():
    ...
    for item in items:
        x_values.append(item['x']) #not sure if this is correct
        y_values.append(item['y'])
    ...
    #apparently the above works as plt.show will try to output the plot on the machine, needs bytes to output on flask
